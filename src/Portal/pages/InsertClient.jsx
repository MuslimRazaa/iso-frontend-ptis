    ...
    <div className="lms-form-panel">
      <header>
        <div>
          ...
          <h2>Insert Client (Bulk Upload)</h2>
          <p className="panel-subtitle">Upload multiple client records using Excel or CSV file.</p>
        </div>
      </header>
      ...
      <div style={{ marginTop: '24px' }}>
        <div className="panel" style={{ padding: '32px', marginBottom: '24px' }}>
          ...
          <ul style={{ 
            ...
            <li>Fill in all client details in the template (Client Name, Industry, Contact, etc.)</li>
            <li>Save the file as Excel (.xlsx) or CSV (.csv) format</li>
            <li>Upload the completed file using the form below</li>
            <li>System will validate and import all client records automatically</li>
          </ul>
        </div>
        ...
        <form className="lms-form-grid" onSubmit={handleBulkUpload}>
          <div className="panel" style={{ padding: '32px' }}>
            ...
            <p style={{ fontSize: '13px', color: '#8c8c94' }}>
              Download the template, fill in client data, and upload it below.
            </p>
          </div>

          <label>
            <span>Upload Client Data File *</span>
            ...
            <div style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
              ...
              <div>
                ...
                <p style={{ fontSize: '13px', color: '#8c6a00', lineHeight: '1.6' }}>
                  Ensure all required fields are filled. Duplicate Client IDs will be skipped. 
